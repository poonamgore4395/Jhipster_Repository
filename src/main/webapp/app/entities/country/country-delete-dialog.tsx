...
export const CountryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipstermyfirstappApp.country.delete.question">
        <Translate contentKey="jhipstermyfirstappApp.country.delete.question" interpolate={{ id: countryEntity.id }}>

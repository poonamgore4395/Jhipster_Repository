...
export const JobHistoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipstermyfirstappApp.jobHistory.delete.question">
        <Translate contentKey="jhipstermyfirstappApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>

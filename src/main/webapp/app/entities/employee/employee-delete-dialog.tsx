...
export const EmployeeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipstermyfirstappApp.employee.delete.question">
        <Translate contentKey="jhipstermyfirstappApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>

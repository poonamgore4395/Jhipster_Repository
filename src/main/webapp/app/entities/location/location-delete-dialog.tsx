...
export const LocationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipstermyfirstappApp.location.delete.question">
        <Translate contentKey="jhipstermyfirstappApp.location.delete.question" interpolate={{ id: locationEntity.id }}>

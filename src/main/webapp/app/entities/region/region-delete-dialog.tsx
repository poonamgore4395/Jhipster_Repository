...
export const RegionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipstermyfirstappApp.region.delete.question">
        <Translate contentKey="jhipstermyfirstappApp.region.delete.question" interpolate={{ id: regionEntity.id }}>

...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipstermyfirstappApp.department.delete.question">
        <Translate contentKey="jhipstermyfirstappApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
